id: DOC-README
title: caelestia-kde README
source: README.md
tags: readme, install, installation, update, updating, uninstall, keybinds, configuring, nexus, troubleshooting, repository layout, requirements, caelestia scheme set, widgets not appearing
synonyms: how do i install, how do i update the shell, how to uninstall, what are the keybinds
